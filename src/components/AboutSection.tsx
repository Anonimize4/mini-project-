  ...
  return (
    <section id="about" className="mb-12">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <h3 className="text-3xl font-semibold mb-6 font-mono" style={{ color: '#39FF14' }}>Community Participation</h3>
          ...
          {[
            {
              ...
              >
                ...
                <p className="text-gray-400 text-base">{activity.description}</p>
              </motion.div>
            ))}
        </div>
      </motion.div>
