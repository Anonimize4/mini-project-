  ...
  const SkillItem = ({ skill, index, delay = 0 }: { 
    ...
    >
      <div className="flex items-center space-x-4 mb-3">
        <div className={`w-14 h-14 ${skill.bgColor} rounded-full flex items-center justify-center flex-shrink-0`}>
  ...
  return (
    <section id="skills" className="mb-12">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          <h3 className="text-3xl font-semibold mb-6 font-mono" style={{ color: '#39FF14' }}>Programming</h3>
        ...
        <div className="flex-1">
          <h3 className="text-3xl font-semibold mb-6 font-mono" style={{ color: '#39FF14' }}>Cybersecurity</h3>
          <div className="space-y-4">
